...
data[keys.RESOURCES] = [
  ...
  {
    [keys.NAME]: "LA Family Housing Family Solution Center",
    [keys.URL]: "https://lafh.org/connect",
    [keys.PHONE]: "8182552766",
    [keys.DATE_CHECKED]: "2026-02-27",
    [keys.ADDRESS_1]: "7817 Lankershim Blvd",
    [keys.CITY]: "North Hollywood",
    [keys.STATE]: "CA",
    [keys.ZIP_CODE]: "91605",
  ...
  {
    [keys.NAME]: "LA Family Housing Individual Solution Center",
    [keys.URL]: "https://lafh.org/connect",
    [keys.PHONE]: "8182552703",
    [keys.DATE_CHECKED]: "2026-02-27",
    [keys.ADDRESS_1]: "7843 Lankershim Blvd",
    [keys.CITY]: "North Hollywood",
    [keys.STATE]: "CA",
    [keys.ZIP_CODE]: "91605",
    [keys.DESCRIPTION]: "Housing and supportive services",
